...
public class Game1Activity extends AppCompatActivity {
    ...
    public void fillView(){
        ...
        Picasso.with(this).load(data.getGame1().getTests().get(current).getUrlAnswer0()).resize(500,500).into((ImageView)findViewById(R.id.game1_answer0_image));
        Picasso.with(this).load(data.getGame1().getTests().get(current).getUrlAnswer1()).resize(500,500).into((ImageView)findViewById(R.id.game1_answer1_image));
        current++;
    }
}
